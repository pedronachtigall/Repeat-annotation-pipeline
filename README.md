...
You can do the annotation at one round (i.e., using the merged file):
```
#run repeatmaskee
...
OR, you can do the annotation "seriated", which you use one file at a time considering the masked gneome of the preivous run:
```
